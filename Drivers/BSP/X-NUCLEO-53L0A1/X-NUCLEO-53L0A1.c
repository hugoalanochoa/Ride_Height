 ...
 *@image html VL53L0A1_board.jpg "X-NUCLEO-53L0A1 Expansion Board"
  ...
  - @ref XNUCLEO53L0A1_Interface
  - Board information and configuration @ref XNUCLEO53L0A1_Board
  - Go to Modules panes


  @section XNUCLEO53L0A1_usage How to use X-NUCLEO-53L0A1 BSP ?
  ## Multiple family project ##
   X-NUCLEO-53L0A1 BSP supports multiple STM32 families through unique "stm32xxx_hal.h".
   This file redirects to the targeted stm32 HAL.
   @note This file can also be used to place any customization defines

  @section XNUCLEO53L0A1_conf  How to configure X-NUCLEO-53L0A1 BSP ?
  ## configuration ##
    see @ref VL53L0A1_config
...
/**
 * @defgroup XNUCLEO53L0A1_Board X-NUCLEO-53L0A1 Expansion Board
 * @{
 */

/**
 * @defgroup VL53L0A1_GPIO1_MAP    VL53L0A1 Sensor to MCU interrupt mapping
 *
 * # GPIO mapping ##
 ...
 *
 * see @a #VL53L0A1_GPIO1_C_OPTION for interrupt line selection
 *
 * @note requires @a #VL53L0A1_GPIO1_SHARED to be set (to 1)
 *
 * ##  One interrupt per sensor  ##
 * To use one interrupt per device :\n
 * @li Do not define @a #VL53L0A1_GPIO1_SHARED  or set to 0
...
/**
 * @defgroup  XNUCLEO53L0A1_I2CExpanders I2C expender mapping
...
/** @} */ /* defgroup  XNUCLEO53L0A1_Board */


/****************************************************
 *@defgroup  XNUCLEO53L0A1_globals
 *@{
 */
 ...
 * can be @a XNUCLEO53L0A1_I2C1Configure() @sa XNUCLEO53L0A1_usage
 * @warning do not use any XNUCLEO53L0A1_xxx prior to a first init with valid i2c handle
 */
...
int XNUCLEO53L0A1_SetIntrStateId(int EnableIntr, int DevNo){
    int status;
    IRQn_Type IntrNo;
    int IntrPin;
    ...
    case 'c' :
        IntrNo = VL53L0A1_GPIO1_C_INTx;
        IntrPin= VL53L0A1_GPIO1_C_GPIO_PIN;
        status = 0;
        break;
#if ! VL53L0A1_GPIO1_SHARED
    case XNUCLEO53L0A1_DEV_LEFT :
    case 'l' :
        IntrNo = VL53L0A1_GPIO1_L_INTx;
        IntrPin= VL53L0A1_GPIO1_L_GPIO_PIN;
        if( VL53L0A1_GPIO1_L_INTx == VL53L0A1_GPIO1_R_INTx || VL53L0A1_GPIO1_L_INTx == VL53L0A1_GPIO1_C_INTx){
            XNUCLEO53L0A1_ErrLog("Conflicting Exti for %d",DevNo);
            status = 1;
    ...
    case XNUCLEO53L0A1_DEV_RIGHT :
        IntrNo = VL53L0A1_GPIO1_R_INTx;
        IntrPin= VL53L0A1_GPIO1_R_GPIO_PIN;
        if( VL53L0A1_GPIO1_L_INTx == VL53L0A1_GPIO1_R_INTx || VL53L0A1_GPIO1_R_INTx == VL53L0A1_GPIO1_C_INTx  ){
            XNUCLEO53L0A1_ErrLog("Conflicting Exti for %d",DevNo);
            status = 1;
            // for treating as error un-comment
            //goto done;
...
void VL53L0A1_EXTI_IOConfigure(int DevNo, int  IntPriority, int SubPriority){
    GPIO_InitTypeDef GPIO_InitStruct;
    ...
    case 'c':
        ...
        HAL_NVIC_SetPriority((IRQn_Type)VL53L0A1_GPIO1_C_GPIO_PIN, IntPriority, SubPriority);
        break;
...
void VL53L0A1_EXTI_IOUnconfigure(int DevNo){
    switch (DevNo ) {
    case XNUCLEO53L0A1_DEV_CENTER:
    case 'c':
        //XNUCLEO53L0A1_SetIntrStateId(0,XNUCLEO53L0A1_DEV_TOP);
        HAL_GPIO_DeInit(VL53L0A1_GPIO1_C_GPIO_PORT, VL53L0A1_GPIO1_C_GPIO_PIN);
        __HAL_GPIO_EXTI_CLEAR_IT(VL53L0A1_GPIO1_C_GPIO_PIN);
        break;
    ...
    case 'l':
       // XNUCLEO53L0A1_SetIntrStateId(0,XNUCLEO53L0A1_DEV_LEFT);
        HAL_GPIO_DeInit(VL53L0A1_GPIO1_L_GPIO_PORT, VL53L0A1_GPIO1_L_GPIO_PIN);
        __HAL_GPIO_EXTI_CLEAR_IT(VL53L0A1_GPIO1_L_GPIO_PIN);
        break;

    case XNUCLEO53L0A1_DEV_RIGHT:
    case 'r':
        HAL_GPIO_DeInit(VL53L0A1_GPIO1_R_GPIO_PORT, VL53L0A1_GPIO1_R_GPIO_PIN);
        __HAL_GPIO_EXTI_CLEAR_IT(VL53L0A1_GPIO1_R_GPIO_PIN);
        //XNUCLEO53L0A1_SetIntrStateId(0,XNUCLEO53L0A1_DEV_RIGHT);
        break;
#endif
    }
